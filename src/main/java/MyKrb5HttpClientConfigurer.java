/*
 A Modified version of Krb5HttpClientConfigurer to support IBM JDK
 */
 ...
 */
public class MyKrb5HttpClientConfigurer extends HttpClientConfigurer {
  
  public static final String LOGIN_CONFIG_PROP = "java.security.auth.login.config";
  private static final Logger logger = LoggerFactory.getLogger(MyKrb5HttpClientConfigurer.class);
  ...
  private static class SolrJaasConfiguration extends javax.security.auth.login.Configuration {
    ...
    private Set<String> initiateAppNames = new HashSet(
      Arrays.asList("com.sun.security.jgss.krb5.initiate", "com.sun.security.jgss.initiate","com.ibm.security.jgss.krb5.initiate","com.ibm.security.jgss.initiate"));

    public SolrJaasConfiguration() {
      try {
        
        this.baseConfig = javax.security.auth.login.Configuration.getConfiguration();
        logger.debug(this.baseConfig.toString());
